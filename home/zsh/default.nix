...

{
  programs.zsh = {
    ...
    shellAliases = {
      claude-qwen-35 = "ANTHROPIC_BASE_URL=http://house-of-wind:8001/v1 claude --model bartowski/Qwen_Qwen3.5-35B-A3B-GGUF:Q8_0";
      claude-qwen-27 = "ANTHROPIC_BASE_URL=http://house-of-wind:8001/v1 claude --model unsloth/Qwen3.5-27B-GGUF:UD-Q4_K_XL";
    }
